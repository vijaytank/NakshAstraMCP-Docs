...
**📥 [Download v3.8.0 Secure Wheel (Windows)](https://github.com/vijaytank/NakshAstraMCP-Docs/releases/download/3.0.0/nakshastramcp-3.8.0-cp313-cp313-win_amd64.whl)**

```powershell
uv tool install https://github.com/vijaytank/NakshAstraMCP-Docs/releases/download/3.0.0/nakshastramcp-3.8.0-cp313-cp313-win_amd64.whl --force
```
